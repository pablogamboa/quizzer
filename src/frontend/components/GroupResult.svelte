...
{:else}
    <HallOfFame
        category={quiz.config.category === 'all' ? null : quiz.config.category}
        difficulty={quiz.config.difficulty === 'all'
            ? null
            : quiz.config.difficulty}
